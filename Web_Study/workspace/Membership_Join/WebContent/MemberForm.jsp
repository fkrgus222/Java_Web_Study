...
<head>
<meta charset="UTF-8">
<title>회원가입 MAKING</title>
<script src = "./JS/juminCheck.js" charset = "UTF-8"></script>
<script src = "./JS/chagne_email.js" charset = "UTF-8"></script>
<style>
	.title {
					...
					<tbody class = "tbody">
						...
						<tr>
							...
							<td>
								...
								<button onclick = "juminCheck(mem_num1.value, mem_num2.value)">ss</button>
						...
						<tr>
							<td>성별</td>
							<td>
								<input type = "radio" name = "new_gender" value = "남성" checked />남성&nbsp;&nbsp;&nbsp;
						...
						<tr>
							...
							<td>
								<script>
									var today = new Date();
									var toyear = parseInt(today.getFullYear());  //2021를 얻어옴!
								...
								<div class = "inputArea">
									...
									<p>
										...
										<input type = "text" name = "userAddr3"
												...
												placeholder = "참고항목( 도로명인 경우: 지역이름과 아파트)"/>
