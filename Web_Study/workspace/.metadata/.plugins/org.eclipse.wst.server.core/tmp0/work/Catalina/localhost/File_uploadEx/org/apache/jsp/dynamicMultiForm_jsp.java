 ...
 * Generated at: 2021-10-21 01:57:06 UTC
...
return;
    ...
    try {
      ...
      out.write("<title>dynamicMultiForm 페이지</title>\r\n");
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("\tvar count = 1; //전역변수\r\n");
      out.write("\t\r\n");
      out.write("\tfunction addRow(){\r\n");
      out.write("\t\tvar dynamicTable = document.getElementById(\"dynamic_table\");\r\n");
      out.write("\t\tvar newRow = dynamicTable.insertRow();   //tr 태그 하나 추가하는것과 마찬가지\r\n");
      ...
      out.write("\t\t\talert(\"파일 사이즈가 20MB 초과되었습니다.\");\r\n");
      ...
      out.write("\t\t\tvar check = checkboxArray[i].checked;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(check){\r\n");
      ...
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<h2>동적 다중 파일 업로드 구현하기</h2>\r\n");
      out.write("\t<form name = \"dynamicForm\" method = \"POST\" enctype = \"multipart/form-data\" action = \"register.jsp\">\r\n");
      ...
      out.write("\t\t<input type = \"button\" value = \"행삭제\" onClick = \"deleteRow();\"/><br><br>\r\n");
      out.write("\t\tCheck&nbsp;&nbsp;&nbsp;&nbsp;업로드할 파일 이름\r\n");
      out.write("\t\t<br>\r\n");
      out.write("\t\t<table id = \"dynamic_table\" border = \"1\" cellpadding = \"0\" cellspacing = \"0\"></table>\r\n");
      out.write("\t\t\t<h4><font color = \"red\">업로드할 파이릉 최대 20MB 까지 업로드 가능합니다!!</font></h4>\r\n");
